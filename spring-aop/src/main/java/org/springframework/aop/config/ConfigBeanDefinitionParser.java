...
class ConfigBeanDefinitionParser implements BeanDefinitionParser {
	...
	public BeanDefinition parse(Element element, ParserContext parserContext) {
		...
		configureAutoProxyCreator(parserContext, element);	// 注册bean AspectJAwareAdvisorAutoProxyCreator

		// 解析<sop:config>下级标签
		List<Element> childElts = DomUtils.getChildElements(element);
		for (Element elt: childElts) {
			String localName = parserContext.getDelegate().getLocalName(elt);
			// 切点函数如：<aop:pointcut id="pointcut" expression="execution (* com.tanglongan.aop.*(..))" />
	...
	// 定义通知，如：<aop:aspect ref="myAspectXML" order="0">
	...
	private AbstractBeanDefinition parseAdvice(
		...
		try {
			...
			// 将 adviceDef 转换成名为 advisorDefinition 的 RootBeanDefinition
